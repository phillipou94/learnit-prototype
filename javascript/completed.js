$(document).ready(function() {
    ...
    $('.exercise-modal > .modal-contents').append("<div class='next'><a class='close-modal'>View Image</a><span>  |  <a href='./collections.html'>My Collection</a><span>  |  </span><a id = 'next' href='./exercise.html'>Next Exercise</a></div>");
